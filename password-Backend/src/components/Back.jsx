...
const Back = () => {
    ...
    return (
        <>
            ...
            <div className="p-3 md:mycontainer text-grey-700 min-h-[88.2vh]">
                ...
                <div className="text-gray-600 flex flex-col p-4 gap-4 items-center">
                    ...
                    <div className="flex flex-col md:flex-row w-full gap-4 justify-between">
                        <input value={form.username} onChange={handlechange} className="rounded-full border border-slate-600 w-full p-4 py-2" type="text" name='username' id='username' placeholder='Enter Username' />
